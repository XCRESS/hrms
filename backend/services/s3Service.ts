...
class S3Service {
  generateFileKey(employeeId: string, fileName: string, isProfilePicture = false): string {
  ...
  async uploadFile(file: Express.Multer.File, employeeId: string, isProfilePicture = false): Promise<UploadResult> {
