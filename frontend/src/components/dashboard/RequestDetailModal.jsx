      ...
      case 'password': {
        ...
        return (
          <div className="space-y-3 sm:space-y-4">
            ...
            {/* <div>
              <label className="text-xs sm:text-sm font-medium text-muted-foreground">Reset Token Status</label>
              <div className="mt-1 p-2 sm:p-3 bg-muted rounded-lg">
            ...
            {/* <div>
              <label className="text-xs sm:text-sm font-medium text-muted-foreground">Reset Process</label>
