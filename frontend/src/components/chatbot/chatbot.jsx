...
const ChatBot = () => {
  const [messages, setMessages] = useState([
    {
      id: 1,
      text: "Hello! I'm your HRMS assistant. I can help you with questions about HR policies, attendance, leaves, salary, and other workplace-related queries. How can I assist you today?",
      sender: 'bot',
      timestamp: new Date(),
    }
  ]);
