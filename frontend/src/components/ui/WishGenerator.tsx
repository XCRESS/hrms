...
const WishGenerator = ({ onClose }: WishGeneratorProps) => {
    ...
    <div className="bg-slate-900 border border-slate-700 rounded-xl p-6 shadow-2xl relative overflow-hidden w-full max-w-lg mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
        ...
        <div>
          ...
          <select
            ...
            onChange={(e: ChangeEvent<HTMLSelectElement>) => setFormData({ ...formData, relationship: e.target.value as Relationship })}
          >
      ...
      <div className="mb-6">
        ...
        <div className="flex flex-wrap gap-2">
          {(['heartfelt', 'funny', 'religious', 'poetic'] as Theme[]).map((t) => (
            <button
              key={t}
