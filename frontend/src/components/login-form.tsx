    ...
    loginMutation.mutate(
      { email, password },
      {
        onSuccess: (data) => {
          ...
          if (!data?.token) {
            console.error("Login success callback received no token:", data);
            return;
          }
        ...
        onError: (error: Error & { status?: number; endpoint?: string; timestamp?: string; responseTime?: number }) => {
          ...
          const errorDetails: ErrorDetails = {
            ...
            isServerError: (error.status || 0) >= 500,
              ...
              <div className="flex flex-col gap-6 py-10">
                ...
                {lastError && (
                  <div className="space-y-3">
                    <div className="bg-red-50 dark:bg-red-950/20 border border-red-200 dark:border-red-800 rounded-lg p-4">
                      <div className="flex items-start gap-3">
                        ...
                        <div className="flex-1">
                          ...
                          {/* Debug controls - only show in development or when enabled via env var */}
                    ...
                    {/* Debug info panel - only render in development */}
                    {showDebugInfo && (import.meta.env.DEV || import.meta.env.VITE_ENABLE_DEBUG === 'true') && (
